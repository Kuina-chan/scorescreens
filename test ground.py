...
texts = [
    ...
    {"type": "count300", "text": f"{str(count300)}x", "position": [26.39, 388.27], "font_size": 69.57},
    {"type": "count100", "text": f"{str(count100)}x", "position": [70.11, 523.1], "font_size": 69.57},
    {"type": "count50", "text": f"{str(count50)}x", "position": [70.11, 655.51], "font_size": 69.57},
    {"type": "count0", "text": f"{str(count0)}x", "position": [70.11, 790], "font_size": 69.57},
]
...
#background.show()
background.save(f"./map_bg/{player} on {beatmap_name} [{diff_name}].png")